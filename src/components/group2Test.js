            ...
            <div className={'tabMainContainer'}>
                <div className={'testLeftDiv'}>
                    <div id="testContainer">
                        ...
                        <Title level={4} id="tutorialTitle" style={{marginBottom:40}}>You could click the button and answer the question to encounter different configurations between button sizes and button distances.</Title>
                        ...
                        <div id="controllerContainer" style={{marginTop:40}}>
                            ...
                            <div className="sliderContainer">
                                ...
                                <Slider value={visualSize} disabled={true} className="slider" onChange={sizeChange}/>
                            </div>
